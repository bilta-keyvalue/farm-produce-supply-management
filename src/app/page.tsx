    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Farm Produce Supply Management</h1>
          <RefreshButton />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-2xl font-bold text-gray-900">{formatNumber(metrics.totalFarms)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Total Acreage</h3>
            <p className="text-2xl font-bold text-gray-900">{formatNumber(metrics.totalAcreage)} acres</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Total Annual Yield</h3>
            <p className="text-2xl font-bold text-gray-900">{formatNumber(metrics.totalAnnualYield)} kg</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border">
